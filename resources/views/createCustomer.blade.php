        ...
        <div class="card">
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <label for="customerNic" class="form-label">Customer Customer and Vehicle Page</label>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3" id="buttonGroup">
                            <button type="button" class="btn btn-success editable-field"
                                id="submitButton31">Submit3</button>
...
<script>
    $(document).ready(function() {
        ...
        $('#newcustomervehiclepage').click(function() {
            ...
            //     this.reset();
            // });
            // Change the ID of the element with ID 'button3' to 'button4'
            $('#submitButton3').prop('id', 'submitButton31');
            $('#form2-body').show(); // Show the form body
